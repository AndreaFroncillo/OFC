...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Righe Linguistiche per la Validazione
    |--------------------------------------------------------------------------
    |
    | Le seguenti righe linguistiche contengono i messaggi di errore predefiniti
    | utilizzati dalla classe validator. Alcune di queste regole hanno più
    | versioni, come le regole di dimensione. Sentiti libero di modificare
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore inserito in :attribute è apparso in un data leak. Scegli un :attribute diverso.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Righe Linguistiche Personalizzate per la Validazione
    |--------------------------------------------------------------------------
    |
    ...
    | righe. Questo rende veloce specificare una riga linguistica specifica
    | per una data regola di attributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti righe linguistiche vengono utilizzate per scambiare il nostro
    | segnaposto dell'attributo con qualcosa di più leggibile come "Indirizzo
    | E-Mail" invece di "email". Questo ci aiuta semplicemente a rendere il
    | nostro messaggio più espressivo.
    |
    */
